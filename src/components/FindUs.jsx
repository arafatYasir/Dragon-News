    ...
    return (
        <div className="mt-[30px]">
            ...
            <div className="join flex join-vertical mt-5">
                <a href="https://www.facebook.com/" target="_blank" className="btn w-3xs lg:w-full gap-3 join-item justify-start py-7 bg-white hover:bg-base-200">
                    <img src={facebookLogo} alt="facebook icon" />
                    <span className="text-[16px] font-medium leading-7 text-[#706F6F]">Facebook</span>
                </a>
                <a href="https://x.com/" target="_blank" className="btn w-3xs lg:w-full gap-3 join-item justify-start py-7 bg-white hover:bg-base-200">
                    <img src={twitterLogo} alt="twitter icon" />
                    <span className="text-[16px] font-medium leading-7 text-[#706F6F]">Twitter</span>
                </a>
                <a href="https://www.instagram.com/" target="_blank" className="btn w-3xs lg:w-full gap-3 join-item justify-start py-7 bg-white hover:bg-base-200">
