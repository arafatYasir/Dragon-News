        ...
        <div className="flex justify-center items-center mt-12">
            <div className="md:w-[752px] bg-white py-[70px] rounded-md">
                ...
                <form>
                    ...
                    <p className="text-center text-[16px] font-semibold leading-7 text-[#706F6F] mt-7">Don't Have An Account? <Link to="/auth/register" className="text-[#F75B5F]">Register</Link></p>
                </form>
            </div>
